...
import com.app.enitity.FileResponse;
...
//	}
	...
	//Post Request
	// this for returning whole FileResponse Entity 
	@PostMapping("/folder")   //http://localhost:8083/folder
	public ResponseEntity<FileResponse> uploadFiletoFileSystem(@RequestParam("uploadfile")MultipartFile file){
		try {
			FileEntity uploadFile = service.uploadFileToFileSystem(file);
			FileResponse fileResponse = new FileResponse(uploadFile.getFilepath(),uploadFile.getFileUuid());
